...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18]">
    ...
    <main class="flex-grow-1 d-flex flex-column">
        ...
        <div class="hero-section">
            <div class="container">
                <h1 class="display-4 fw-bold">Koleksi {{ ucfirst(str_replace('_', ' ', $category->category_name)) }}
                </h1>
                <p class="lead">Temukan koleksi {{ ucfirst(str_replace('_', ' ', $category->category_name)) }}
                    terlengkap untuk mendukung pembelajaran dan penelitian Anda.</p>
            </div>
        </div>
            ...
            <div class="row search-bar">
                <div class="col-12 col-md-8 mx-auto">
                    <form class="d-flex flex-wrap align-items-center justify-content-center text-white"
                        ...
                        <select class="form-select form-select-sm me-2 mb-2 mb-md-0" name="search_by"
                            style="width: auto;">
                        ...
                        <select class="form-select form-select-sm me-2 mb-2 mb-md-0" name="category"
                            style="width: auto;">
                            <option value="">Semua Kategori</option>
                            <option value="karya_tulis_ilmiah"
                                {{ request('category') == 'karya_tulis_ilmiah' ? 'selected' : '' }}>Karya Tulis Ilmiah
                            </option>
                            <option value="poster" {{ request('category') == 'poster' ? 'selected' : '' }}>Poster
                            </option>
                            <option value="penelitian_eksternal"
                                {{ request('category') == 'penelitian_eksternal' ? 'selected' : '' }}>Penelitian
                                Eksternal</option>
        ...
        <div class="container my-4 flex-grow-1 d-flex flex-column">
            <h2 class="text-center mb-4 text-success">Daftar
