<ul class="navbar-nav sidebar sidebar-light bg-white shadow-sm" id="accordionSidebar" style="min-height: 100vh;">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center py-3 mb-3 border-bottom"
    ...
    <li class="nav-item {{ Request::is('dashboard') ? 'active' : '' }}">
        <a class="nav-link text-primary {{ Request::is('dashboard') ? 'fw-bold bg-light rounded' : '' }}"
            href="{{ route('dashboard') }}">
    ...
    <li class="nav-item {{ Request::is('library*') ? 'active' : '' }}">
        <a class="nav-link text-primary {{ Request::is('library*') ? 'fw-bold bg-light rounded' : '' }}"
            href="{{ route('library') }}">
    ...
    <li class="nav-item {{ Request::is('logs*') ? 'active' : '' }}">
        <a class="nav-link text-primary {{ Request::is('logs*') ? 'fw-bold bg-light rounded' : '' }}"
